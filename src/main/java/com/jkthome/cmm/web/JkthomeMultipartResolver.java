...
public class JkthomeMultipartResolver extends CommonsMultipartResolver {

	private static final Logger LOGGER = LoggerFactory.getLogger(JkthomeMultipartResolver.class);

	public JkthomeMultipartResolver() {}
     ...
     */
    public JkthomeMultipartResolver(ServletContext servletContext) {
